  ...
  if (!session) {
    return (
      <div className="min-h-[80vh] flex flex-col items-center justify-center p-4 text-center">
        <h1 className="text-6xl md:text-8xl font-black mb-4 tracking-tighter text-sunset italic">
          TECHNO<br />TRACKER
        </h1>
        <p className="text-xl md:text-2xl text-white/70 mb-12 max-w-2xl font-bold italic uppercase tracking-tighter">
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 pt-12">
      <div className="flex items-center justify-between mb-12">
        <div>
          <h1 className="text-5xl font-black mb-2 text-sunset uppercase tracking-tighter italic">MON PALMARÈS</h1>
          <p className="text-white/60 font-black uppercase tracking-widest text-sm italic">
